...
Its quite basic, so don't expect much but yes we do have a permissions system built in. It also support implementing your own backend if you wanted to say store it in a DB
